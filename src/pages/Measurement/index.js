...
`;
    ...
    const data = [
        { title: "Alunos Registrados", value: relatorio ? relatorio.clientes : 0, percentage: "+0%" },
        { title: "Aprovados", value: relatorio.clientesAtendidos ? relatorio.clientesAtendidos : 0, percentage: "+0%" },
        ];
            ...
            <Body>
                ...
                <Container2>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', width: '95%' }} >
                        ...
                        <Typography style={{ fontWeight: 'bold', color: 'black', fontSize: '22px', alignSelf: 'flex-start' }} >Candidatos Aprovados:</Typography>
                        ...
                        <Typography style={{ fontWeight: 'bold', color: 'white', fontSize: '22px' }} >Aprovados: </Typography>
